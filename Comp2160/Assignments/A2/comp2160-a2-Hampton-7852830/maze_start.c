...
// addCell
//
// PURPOSE: adds the cell passed into a linked
// 
//
//
// INPUT PARAMETERS:
// It receives a Cell
// OUTPUT PARAMETERS:
// None. Only adds items at the top of the list
// 
//------------------------------------------------------
void addCell(const Cell cell)
{
